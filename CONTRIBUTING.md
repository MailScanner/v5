...
important, please try to provide them. If your examples use domains that you
do not own, please be respectful and either redact or replace them with
example.com, example.net, or example.org.
See https://datatracker.ietf.org/doc/html/rfc2606 for more information.
