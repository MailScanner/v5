...
if [ -d '/etc/rc.d/init.d' -a ! -L '/etc/rc.d/init.d/mailscanner' -a -f '/var/lib/MailScanner/init/mailscanner' ]; then
	ln -s /var/lib/MailScanner/init/mailscanner /etc/rc.d/init.d/mailscanner
fi
...
%attr(755,root,root) /var/lib/MailScanner/init/mailscanner
